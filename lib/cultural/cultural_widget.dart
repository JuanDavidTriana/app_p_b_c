import 'package:app_p_b_c/cultural/cultural_intro_widget.dart';
...
class CulturalWidget extends StatefulWidget {
  const CulturalWidget({Key key}) : super(key: key);

  @override
  _CulturalWidgetState createState() => _CulturalWidgetState();
}

class _CulturalWidgetState extends State<CulturalWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/cultural_inicio.png',
                      ).image,
                    ),
                  ),
                  child: Row(
