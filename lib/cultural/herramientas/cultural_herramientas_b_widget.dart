...
import 'package:app_p_b_c/cultural/games/game_b/cultural_game_b_widget.dart';
import 'package:app_p_b_c/cultural/herramientas/cultural_herramientas_a_widget.dart';
...
class CulturalHerramientasBWidget extends StatefulWidget {
  const CulturalHerramientasBWidget({Key key}) : super(key: key);

  @override
  _CulturalHerramientasBWidgetState createState() =>
      _CulturalHerramientasBWidgetState();
}

class _CulturalHerramientasBWidgetState extends State<CulturalHerramientasBWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/cultural_herramientas_b.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                                  ...
                                  child: ListView(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Image.asset(
                                            'assets/images/infografia_cultural_b.png',
                                                ...
                                                InkWell(
                                                  onTap: () async {
                                                    await Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                        builder: (context) => CulturalGameBWidget(),
                                                      ),
                                                    );
                                                  },
                                                  child: Image.asset(
