...
import 'package:app_p_b_c/cultural/games/game_a/cultural_game_a_widget.dart';
import 'package:app_p_b_c/cultural/herramientas/cultural_herramientas_b_widget.dart';
...
class CulturalHerramientasAWidget extends StatefulWidget {
  const CulturalHerramientasAWidget({Key key}) : super(key: key);

  @override
  _CulturalHerramientasAWidgetState createState() =>
      _CulturalHerramientasAWidgetState();
}

class _CulturalHerramientasAWidgetState extends State<CulturalHerramientasAWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/cultural_herramientas_a.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                                  ...
                                  child: ListView(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Image.asset(
                                            'assets/images/infografia_cultural_a.png',
                                                ...
                                                InkWell(
                                                  onTap: () async {
                                                    await Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                        builder: (context) => CulturalGameAWidget(),
                                                      ),
                                                    );
                                                  },
                                                  child: Image.asset(
