...
class CulturalIntroWidget extends StatefulWidget {
  const CulturalIntroWidget({Key key}) : super(key: key);

  @override
  _CulturalIntroWidgetState createState() => _CulturalIntroWidgetState();
}

class _CulturalIntroWidgetState extends State<CulturalIntroWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/intro_cultural.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/LPlHH-1NadA',
