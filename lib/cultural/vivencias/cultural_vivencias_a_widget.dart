...
class CulturalVivenciasAWidget extends StatefulWidget {
  const CulturalVivenciasAWidget({Key key}) : super(key: key);

  @override
  _CulturalVivenciasAWidgetState createState() => _CulturalVivenciasAWidgetState();
}

class _CulturalVivenciasAWidgetState extends State<CulturalVivenciasAWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/cultural_vivencias_a.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/ws3j7kSLY4g',
