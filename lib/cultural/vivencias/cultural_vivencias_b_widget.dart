...
class CulturalVivenciasBWidget extends StatefulWidget {
  const CulturalVivenciasBWidget({Key key}) : super(key: key);

  @override
  _CulturalVivenciasBWidget createState() => _CulturalVivenciasBWidget();
}

class _CulturalVivenciasBWidget extends State<CulturalVivenciasBWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/cultural_vivencias_b.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/IIL9y0l2zqY',
