...
class MaterialIntroWidget extends StatefulWidget {
  const MaterialIntroWidget({Key key}) : super(key: key);

  @override
  _MaterialIntroWidgetState createState() => _MaterialIntroWidgetState();
}

class _MaterialIntroWidgetState extends State<MaterialIntroWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/intro_material.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/rJY1VdpzmXM',
