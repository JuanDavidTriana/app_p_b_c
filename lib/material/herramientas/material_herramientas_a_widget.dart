...
import 'package:app_p_b_c/material/games/game_a/material_game_a_widget.dart';
import 'package:app_p_b_c/material/herramientas/material_herramientas_b_widget.dart';
import 'package:app_p_b_c/material/material_widget.dart';
import 'package:app_p_b_c/material/vivencias/material_vivencias_b_widget.dart';
...
class MaterialHerramientasAWidget extends StatefulWidget {
  const MaterialHerramientasAWidget({Key key}) : super(key: key);

  @override
  _MaterialHerramientasAWidgetState createState() =>
      _MaterialHerramientasAWidgetState();
}

class _MaterialHerramientasAWidgetState extends State<MaterialHerramientasAWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/material_herramientas_a.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                                  ...
                                  child: ListView(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Image.asset(
                                            'assets/images/infografia_material_a.png',
                                                ...
                                                InkWell(
                                                  onTap: () async {
                                                    await Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                        builder: (context) => MaterialGameAWidget(),
                                                      ),
                                                    );
                                                  },
                                                  child: Image.asset(
