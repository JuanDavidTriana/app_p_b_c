...
class MaterialVivenciasAWidget extends StatefulWidget {
  const MaterialVivenciasAWidget({Key key}) : super(key: key);

  @override
  _MaterialVivenciasAWidgetState createState() => _MaterialVivenciasAWidgetState();
}

class _MaterialVivenciasAWidgetState extends State<MaterialVivenciasAWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/material_vivencias_a.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/fGbMGDtVf44',
