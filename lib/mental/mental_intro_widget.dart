...
class MentalIntroWidget extends StatefulWidget {
  const MentalIntroWidget({Key key}) : super(key: key);

  @override
  _MentalIntroWidgetState createState() => _MentalIntroWidgetState();
}

class _MentalIntroWidgetState extends State<MentalIntroWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/intro_mental.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/1TbgS_H8tEw',
