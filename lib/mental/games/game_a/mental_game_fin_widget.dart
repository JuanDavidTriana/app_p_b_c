...
class MentalGameFinWidget extends StatefulWidget {
  const MentalGameFinWidget({Key key}) : super(key: key);

  @override
  _MentalGameFinWidgetState createState() => _MentalGameFinWidgetState();
}

class _MentalGameFinWidgetState extends State<MentalGameFinWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/fondo_mental_fin.png',
                      ).image,
                    ),
                  ),
                  child: Row(
