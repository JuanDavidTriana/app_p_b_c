...
import 'package:app_p_b_c/mental/games/game_b/mental_game_b4_widget.dart';
...
class MentalGameB3Widget extends StatefulWidget {
  const MentalGameB3Widget({Key key}) : super(key: key);

  @override
  _MentalGameB3WidgetState createState() => _MentalGameB3WidgetState();
}

class _MentalGameB3WidgetState extends State<MentalGameB3Widget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/mental_fondo_game_2c.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              Image.asset(
                                                'assets/images/gameb_mental/herramienta_opt_3_a.png',
                                                width: MediaQuery.of(
                                                    context)
                                                    .size
                                                    .width *
                                                ...
                                                child: DragTarget<String>(
                                                  builder: (
                                                    ...
                                                    return Container(
                                                      ...
                                                      child: Image.asset('assets/images/gameb_mental/herramienta_opt_3_b.png'),
                                                    );
                                                  },
                                                  onWillAccept: (data) {
                                                    return data == _q;
                                                  ...
                                                  onAccept: (data) async {
                                                    await Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                        builder: (context) => MentalGameB4Widget(),
                                                      ),
                                                    );
