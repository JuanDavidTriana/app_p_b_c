...
import 'package:app_p_b_c/mental/games/game_b/mental_game_b2_widget.dart';
...
class MentalGameBWidget extends StatefulWidget {
  const MentalGameBWidget({Key key}) : super(key: key);

  @override
  _MentalGameBWidgetState createState() => _MentalGameBWidgetState();
}

class _MentalGameBWidgetState extends State<MentalGameBWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/mental_fondo_game_2a.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                                ...
                                                child: DragTarget<String>(
                                                  builder: (
                                                    ...
                                                    return Container(
                                                      ...
                                                      child: Image.asset('assets/images/gameb_mental/herramienta_opt_1_a.png'),
                                                    );
                                                  },
                                                  onWillAccept: (data) {
                                                    return data == _q;
                                                  ...
                                                  onAccept: (data) async {
                                                    ...
                                                    await Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                        builder: (context) => MentalGameB2Widget(),
                                                      ),
                                                    );
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Image.asset(
                                                'assets/images/gameb_mental/herramienta_opt_1_b.png',
                                                width: MediaQuery.of(
                                                    context)
                                                    .size
                                                    .width *
