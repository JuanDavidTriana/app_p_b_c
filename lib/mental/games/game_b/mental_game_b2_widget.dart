...
import 'package:app_p_b_c/mental/games/game_b/mental_game_b3_widget.dart';
...
class MentalGameB2Widget extends StatefulWidget {
  const MentalGameB2Widget({Key key}) : super(key: key);

  @override
  _MentalGameB2WidgetState createState() => _MentalGameB2WidgetState();
}

class _MentalGameB2WidgetState extends State<MentalGameB2Widget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/mental_fondo_game_2b.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              Image.asset(
                                                'assets/images/gameb_mental/herramienta_opt_2_a.png',
                                                width: MediaQuery.of(
                                                    context)
                                                    .size
                                                    .width *
                                                ...
                                                child: DragTarget<String>(
                                                  builder: (
                                                    ...
                                                    return Container(
                                                      ...
                                                      child: Image.asset('assets/images/gameb_mental/herramienta_opt_2_b.png'),
                                                    );
                                                  },
                                                  onWillAccept: (data) {
                                                    return data == _q;
                                                  ...
                                                  onAccept: (data) async {
                                                    ...
                                                    await Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                        builder: (context) => MentalGameB3Widget(),
                                                      ),
                                                    );
