...
import 'package:app_p_b_c/mental/games/game_b/mental_game_b_widget.dart';
...
class MentalGameB5Widget extends StatefulWidget {
  const MentalGameB5Widget({Key key}) : super(key: key);

  @override
  _MentalGameB5WidgetState createState() => _MentalGameB5WidgetState();
}

class _MentalGameB5WidgetState extends State<MentalGameB5Widget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/mental_fondo_game_2e.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                                ...
                                                child: DragTarget<String>(
                                                  builder: (
                                                    ...
                                                    return Container(
                                                      ...
                                                      child: Image.asset('assets/images/gameb_mental/herramienta_opt_5_a.png'),
                                                    );
                                                  },
                                                  onWillAccept: (data) {
                                                    return data == _q;
                                                  ...
                                                  onAccept: (data) async {
                                                    ...
                                                    await Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                        builder: (context) => MentalGameBWidget(),
                                                      ),
                                                    );
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Image.asset(
                                                'assets/images/gameb_mental/herramienta_opt_5_b.png',
                                                width: MediaQuery.of(
                                                    context)
                                                    .size
                                                    .width *
