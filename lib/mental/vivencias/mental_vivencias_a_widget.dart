...
class MentalVivenciasAWidget extends StatefulWidget {
  const MentalVivenciasAWidget({Key key}) : super(key: key);

  @override
  _MentalVivenciasAWidgetState createState() => _MentalVivenciasAWidgetState();
}

class _MentalVivenciasAWidgetState extends State<MentalVivenciasAWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/mental_vivencias_a.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/DbOL7FN6HPY',
