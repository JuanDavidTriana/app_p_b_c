...
class MentalVivenciasBWidget extends StatefulWidget {
  const MentalVivenciasBWidget({Key key}) : super(key: key);

  @override
  _MentalVivenciasBWidgetState createState() => _MentalVivenciasBWidgetState();
}

class _MentalVivenciasBWidgetState extends State<MentalVivenciasBWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/mental_vivencias_b.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/nThHWvu6IVQ',
