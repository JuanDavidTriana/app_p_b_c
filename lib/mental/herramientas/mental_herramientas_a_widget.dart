...
class MentalHerramientasAWidget extends StatefulWidget {
  const MentalHerramientasAWidget({Key key}) : super(key: key);

  @override
  _MentalHerramientasAWidgetState createState() =>
      _MentalHerramientasAWidgetState();
}

class _MentalHerramientasAWidgetState extends State<MentalHerramientasAWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/mental_herramientas_a.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                                  ...
                                  child: ListView(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Image.asset(
                                            'assets/images/infografia_mental_a.png',
                                                ...
                                                InkWell(
                                                  onTap: () async {
                                                    await Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                        builder: (context) => MentalGameAWidget(),
                                                      ),
                                                    );
                                                  },
                                                  child: Image.asset(
