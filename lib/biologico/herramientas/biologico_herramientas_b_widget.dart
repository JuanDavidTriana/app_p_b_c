...
import 'package:app_p_b_c/biologico/games/game_b/biologico_game_b_widget.dart';
...
class BiologicoHerramientasBWidget extends StatefulWidget {
  const BiologicoHerramientasBWidget({Key key}) : super(key: key);

  @override
  _BiologicoHerramientasBWidgetState createState() =>
      _BiologicoHerramientasBWidgetState();
}

class _BiologicoHerramientasBWidgetState extends State<BiologicoHerramientasBWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/biologico_herramientas_b.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                                  ...
                                  child: ListView(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Image.asset(
                                            'assets/images/infografia_biologico_b.png',
                                                ...
                                                InkWell(
                                                  onTap: () async {
                                                    await Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                        builder: (context) => BiologicoGameBWidget(),
                                                      ),
                                                    );
                                                  },
                                                  child: Image.asset(
