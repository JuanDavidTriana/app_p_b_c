...
import 'package:app_p_b_c/biologico/games/game_a/biologico_game_a_widget.dart';
...
class BiologicoHerramientasAWidget extends StatefulWidget {
  const BiologicoHerramientasAWidget({Key key}) : super(key: key);

  @override
  _BiologicoHerramientasAWidgetState createState() =>
      _BiologicoHerramientasAWidgetState();
}

class _BiologicoHerramientasAWidgetState extends State<BiologicoHerramientasAWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/biologico_herramientas_a.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                                  ...
                                  child: ListView(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Image.asset(
                                            'assets/images/infografia_biologico_a.png',
                                                ...
                                                InkWell(
                                                  onTap: () async {
                                                    await Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                        builder: (context) => BiologicoGameAWidget(),
                                                      ),
                                                    );
                                                  },
                                                  child: Image.asset(
