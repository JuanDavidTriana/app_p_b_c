import 'package:app_p_b_c/biologico/biologico_intro_widget.dart';
import 'package:app_p_b_c/biologico/herramientas/biologico_herramientas_a_widget.dart';
import 'package:app_p_b_c/biologico/herramientas/biologico_herramientas_b_widget.dart';
import 'package:app_p_b_c/biologico/vivencias/biologico_vivencias_a_widget.dart';
import 'package:app_p_b_c/biologico/vivencias/biologico_vivencias_b_widget.dart';
...
class BiologicoWidget extends StatefulWidget {
  const BiologicoWidget({Key key}) : super(key: key);

  @override
  _BiologicoWidgetState createState() => _BiologicoWidgetState();
}

class _BiologicoWidgetState extends State<BiologicoWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/biologico_inicio.png',
                      ).image,
                    ),
                  ),
                  child: Row(
