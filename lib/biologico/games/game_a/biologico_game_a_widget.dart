...
class BiologicoGameAWidget extends StatefulWidget {
  const BiologicoGameAWidget({Key key}) : super(key: key);

  @override
  _BiologicoGameAWidgetState createState() => _BiologicoGameAWidgetState();
}

class _BiologicoGameAWidgetState extends State<BiologicoGameAWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/biologico_fondo_game_a.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                                            ...
                                            builder: (
                                              ...
                                              return Container(
                                                ...
                                                child: Image.asset(_is1VDropped
                                                    ? 'assets/images/gamea_biologico/01.png'
                                                    : 'assets/images/gamea_biologico/gris.jpg'),
                                              );
                                            },
                                            onWillAccept: (data) {
                                              return data == _1G;
                                            ...
                                            builder: (
                                              ...
                                              return Container(
                                                ...
                                                child: Image.asset(_is2VDropped
                                                    ? 'assets/images/gamea_biologico/02.png'
                                                    : 'assets/images/gamea_biologico/gris.jpg'),
                                              );
                                            },
                                            onWillAccept: (data) {
                                            ...
                                            builder: (
                                              ...
                                              return Container(
                                                ...
                                                child: Image.asset(_is3VDropped
                                                    ? 'assets/images/gamea_biologico/03.png'
                                                    : 'assets/images/gamea_biologico/gris.jpg'),
                                              );
                                            },
                                            onWillAccept: (data) {
                                            ...
                                            builder: (
                                              ...
                                              return Container(
                                                ...
                                                child: Image.asset(_is4VDropped
                                                    ? 'assets/images/gamea_biologico/04.png'
                                                    : 'assets/images/gamea_biologico/gris.jpg',fit: BoxFit.contain,),
                                              );
                                            },
                                            onWillAccept: (data) {
                                              return data == _4G;
                                            ...
                                            builder: (
                                              ...
                                              return Container(
                                                ...
                                                child: Image.asset(_is5VDropped
                                                    ? 'assets/images/gamea_biologico/05.png'
                                                    : 'assets/images/gamea_biologico/gris.jpg',fit: BoxFit.contain,),
                                              );
                                            },
                                            onWillAccept: (data) {
                                            ...
                                            builder: (
                                              ...
                                              return Container(
                                                ...
                                                child: Image.asset(_is6VDropped
                                                    ? 'assets/images/gamea_biologico/06.png'
                                                    : 'assets/images/gamea_biologico/gris.jpg',fit: BoxFit.contain,),
                                              );
                                            },
                                            onWillAccept: (data) {
                                            ...
                                            builder: (
                                              ...
                                              return Container(
                                                ...
                                                child: Image.asset(_is7VDropped
                                                    ? 'assets/images/gamea_biologico/07.png'
                                                    : 'assets/images/gamea_biologico/gris.jpg',fit: BoxFit.contain,),
                                              );
                                            },
                                            onWillAccept: (data) {
                                            ...
                                            builder: (
                                              ...
                                              return Container(
                                                ...
                                                child: Image.asset(_is8VDropped
                                                    ? 'assets/images/gamea_biologico/08.png'
                                                    : 'assets/images/gamea_biologico/gris.jpg',fit: BoxFit.contain,),
                                              );
                                            },
                                            onWillAccept: (data) {
                                            ...
                                            builder: (
                                              ...
                                              return Container(
                                                ...
                                                child: Image.asset(_is9VDropped
                                                    ? 'assets/images/gamea_biologico/09.png'
                                                    : 'assets/images/gamea_biologico/gris.jpg',fit: BoxFit.contain,),
                                              );
                                            },
                                            onWillAccept: (data) {
                                        ...
                                        Visibility(
                                          ...
                                          child: Draggable<String>(
                                            ...
                                            child: Container(
                                              ...
                                              height: MediaQuery.of(context).size.height * 0.15,
                                              child: Center(
                                                child: Image.asset('assets/images/gamea_biologico/03.png'),
                                              ),
                                            ),
                                            feedback: Container(
                                              width: MediaQuery.of(context).size.width * 0.1,
                                        ...
                                        Visibility(
                                          ...
                                          child: Draggable<String>(
                                            ...
                                            child: Container(
                                              ...
                                              height: MediaQuery.of(context).size.height * 0.15,
                                              child: Center(
                                                child: Image.asset('assets/images/gamea_biologico/06.png'),
                                              ),
                                            ),
                                            feedback: Container(
                                              width: MediaQuery.of(context).size.width * 0.1,
                                        ...
                                        Visibility(
                                          ...
                                          child: Draggable<String>(
                                            ...
                                            child: Container(
                                              ...
                                              height: MediaQuery.of(context).size.height * 0.15,
                                              child: Center(
                                                child: Image.asset('assets/images/gamea_biologico/04.png'),
                                              ),
                                            ),
                                            feedback: Container(
                                              width: MediaQuery.of(context).size.width * 0.1,
                                        ...
                                        Visibility(
                                          ...
                                          child: Draggable<String>(
                                            ...
                                            child: Container(
                                              ...
                                              height: MediaQuery.of(context).size.height * 0.15,
                                              child: Center(
                                                child: Image.asset('assets/images/gamea_biologico/08.png'),
                                              ),
                                            ),
                                            feedback: Container(
                                              width: MediaQuery.of(context).size.width * 0.1,
                                        ...
                                        Visibility(
                                          ...
                                          child: Draggable<String>(
                                            ...
                                            child: Container(
                                              ...
                                              height: MediaQuery.of(context).size.height * 0.15,
                                              child: Center(
                                                child: Image.asset('assets/images/gamea_biologico/09.png'),
                                              ),
                                            ),
                                            feedback: Container(
                                              width: MediaQuery.of(context).size.width * 0.1,
                                        ...
                                        Visibility(
                                          ...
                                          child: Draggable<String>(
                                            ...
                                            child: Container(
                                              ...
                                              height: MediaQuery.of(context).size.height * 0.15,
                                              child: Center(
                                                child: Image.asset('assets/images/gamea_biologico/02.png'),
                                              ),
                                            ),
                                            feedback: Container(
                                              width: MediaQuery.of(context).size.width * 0.1,
                                        ...
                                        Visibility(
                                          ...
                                          child: Draggable<String>(
                                            ...
                                            child: Container(
                                              ...
                                              height: MediaQuery.of(context).size.height * 0.15,
                                              child: Center(
                                                child: Image.asset('assets/images/gamea_biologico/07.png'),
                                              ),
                                            ),
                                            feedback: Container(
                                              width: MediaQuery.of(context).size.width * 0.1,
                                        ...
                                        Visibility(
                                          ...
                                          child: Draggable<String>(
                                            ...
                                            child: Container(
                                              ...
                                              height: MediaQuery.of(context).size.height * 0.15,
                                              child: Center(
                                                child: Image.asset('assets/images/gamea_biologico/01.png'),
                                              ),
                                            ),
                                            feedback: Container(
                                              width: MediaQuery.of(context).size.width * 0.1,
                                        ...
                                        Visibility(
                                          ...
                                          child: Draggable<String>(
                                            ...
                                            child: Container(
                                              ...
                                              height: MediaQuery.of(context).size.height * 0.15,
                                              child: Center(
                                                child: Image.asset('assets/images/gamea_biologico/05.png'),
                                              ),
                                            ),
                                            feedback: Container(
                                              width: MediaQuery.of(context).size.width * 0.1,
