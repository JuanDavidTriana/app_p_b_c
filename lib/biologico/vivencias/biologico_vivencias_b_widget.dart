...
class BiologicoVivenciasBWidget extends StatefulWidget {
  const BiologicoVivenciasBWidget({Key key}) : super(key: key);

  @override
  _BiologicoVivenciasBWidgetState createState() => _BiologicoVivenciasBWidgetState();
}

class _BiologicoVivenciasBWidgetState extends State<BiologicoVivenciasBWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/biologico_vivencias_b.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/sngWzYO_74Q',
