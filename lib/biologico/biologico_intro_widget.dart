...
class BiologicoIntroWidget extends StatefulWidget {
  const BiologicoIntroWidget({Key key}) : super(key: key);

  @override
  _BiologicoIntroWidgetState createState() => _BiologicoIntroWidgetState();
}

class _BiologicoIntroWidgetState extends State<BiologicoIntroWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/intro_biologico.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/mRyO32xn5cw',
