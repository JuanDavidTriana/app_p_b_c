...
import 'package:app_p_b_c/social/games/game_a/social_game_b_widget.dart';
...
class SocialHerramientasAWidget extends StatefulWidget {
  const SocialHerramientasAWidget({Key key}) : super(key: key);

  @override
  _SocialHerramientasAWidgetState createState() =>
      _SocialHerramientasAWidgetState();
}

class _SocialHerramientasAWidgetState extends State<SocialHerramientasAWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/social_herramientas_a.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                                  ...
                                  child: ListView(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Image.asset(
                                            'assets/images/infografia_social_a.png',
                                                ...
                                                InkWell(
                                                  onTap: () async {
                                                    await Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                        builder: (context) => SocialGameAWidget(),
                                                      ),
                                                    );
                                                  },
                                                  child: Image.asset(
