...
import 'package:app_p_b_c/social/social_intro_widget.dart';
...
class SocialVivenciasAWidget extends StatefulWidget {
  const SocialVivenciasAWidget({Key key}) : super(key: key);

  @override
  _SocialVivenciasAWidgetState createState() => _SocialVivenciasAWidgetState();
}

class _SocialVivenciasAWidgetState extends State<SocialVivenciasAWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/social_vivencias_a.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/5AAj49qrfyk',
