...
class EspiritualVivenciasBWidget extends StatefulWidget {
  const EspiritualVivenciasBWidget({Key key}) : super(key: key);

  @override
  _EspiritualVivenciasBWidgetState createState() => _EspiritualVivenciasBWidgetState();
}

class _EspiritualVivenciasBWidgetState extends State<EspiritualVivenciasBWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/espiritual_vivencias_b.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/ZRPT584kPbo',
