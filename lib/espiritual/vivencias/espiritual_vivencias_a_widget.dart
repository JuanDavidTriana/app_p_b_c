...
class EspiritualVivenciasAWidget extends StatefulWidget {
  const EspiritualVivenciasAWidget({Key key}) : super(key: key);

  @override
  _EspiritualVivenciasAWidgetState createState() => _EspiritualVivenciasAWidgetState();
}

class _EspiritualVivenciasAWidgetState extends State<EspiritualVivenciasAWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/espiritual_vivencias_a.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/nbXT7N0cMPI',
