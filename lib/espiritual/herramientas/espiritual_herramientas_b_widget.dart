...
class EspiritualHerramientasBWidget extends StatefulWidget {
  const EspiritualHerramientasBWidget({Key key}) : super(key: key);

  @override
  _EspiritualHerramientasBWidgetState createState() =>
      _EspiritualHerramientasBWidgetState();
}

class _EspiritualHerramientasBWidgetState extends State<EspiritualHerramientasBWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/espiritual_herramientas_b.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                                  ...
                                  child: ListView(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Image.asset(
                                            'assets/images/infografia_espiritual_b.png',
                                                ...
                                                InkWell(
                                                  onTap: () async {
                                                    await Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                        builder: (context) => EspiritualGameBWidget(),
                                                      ),
                                                    );
                                                  },
                                                  child: Image.asset(
