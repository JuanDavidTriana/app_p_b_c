...
import 'package:app_p_b_c/emocional/vivencias/emocional_vivencias_b_widget.dart';
import 'package:app_p_b_c/espiritual/games/game_a/espiritual_game_a_widget.dart';
...
class EspiritualHerramientasAWidget extends StatefulWidget {
  const EspiritualHerramientasAWidget({Key key}) : super(key: key);

  @override
  _EspiritualHerramientasAWidgetState createState() =>
      _EspiritualHerramientasAWidgetState();
}

class _EspiritualHerramientasAWidgetState extends State<EspiritualHerramientasAWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/espiritual_herramientas_a.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                                  ...
                                  child: ListView(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Image.asset(
                                            'assets/images/infografia_espiritual_a.png',
                                                ...
                                                InkWell(
                                                  onTap: () async {
                                                    await Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                        builder: (context) => EspiritualGameAWidget(),
                                                      ),
                                                    );
                                                  },
                                                  child: Image.asset(
