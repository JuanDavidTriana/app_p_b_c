...
class EspiritualIntroWidget extends StatefulWidget {
  const EspiritualIntroWidget({Key key}) : super(key: key);

  @override
  _EspiritualIntroWidgetState createState() => _EspiritualIntroWidgetState();
}

class _EspiritualIntroWidgetState extends State<EspiritualIntroWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/intro_espiritual.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/YdzXF8pI8IE',
