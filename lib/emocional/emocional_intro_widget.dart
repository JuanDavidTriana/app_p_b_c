...
class EmocionalIntroWidget extends StatefulWidget {
  const EmocionalIntroWidget({Key key}) : super(key: key);

  @override
  _EmocionalIntroWidgetState createState() => _EmocionalIntroWidgetState();
}

class _EmocionalIntroWidgetState extends State<EmocionalIntroWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/intro_emocional.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/2O-rCC-D5Js',
