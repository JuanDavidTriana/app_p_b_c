...
class EmocionalGameBWidget extends StatefulWidget {
  const EmocionalGameBWidget({Key key}) : super(key: key);

  @override
  _EmocionalGameBWidgetState createState() => _EmocionalGameBWidgetState();
}

class _EmocionalGameBWidgetState extends State<EmocionalGameBWidget> {
...
final _questions = const [
  {
    'question': 'assets/images/gameb_emocional/img1.png',
    'answers': [
      {'answerText': 'Reflexionar sobre el propio papel', 'score': false},
      {'answerText': 'Expresar emociones y sentimientos', 'score': false},
      {'answerText': 'Identificar la raíz del conflicto', 'score': true},
      {'answerText': 'Mediar con la contraparte', 'score': false},
      {'answerText': 'Soltar rencores y rabia', 'score': false},
    ],
  },
  {
    'question': 'assets/images/gameb_emocional/img2.png',
    'answers': [
      {'answerText': 'Expresar emociones y sentimientos', 'score': false},
      {'answerText': 'Mediar con la contraparte', 'score': false},
      {'answerText': 'Soltar rencores y rabia', 'score': false},
      {'answerText': 'Reflexionar sobre el propio papel', 'score': true},
    ],
  },
  {
    'question': 'assets/images/gameb_emocional/img3.png',
    'answers': [
      {'answerText': 'Mediar con la contraparte', 'score': false},
      {'answerText': 'Soltar rencores y rabia', 'score': false},
      {'answerText': 'Expresar emociones y sentimientos', 'score': true},
    ],
  },
  {
    'question': 'assets/images/gameb_emocional/img4.png',
    'answers': [
      {'answerText': 'Soltar rencores y rabia', 'score': false},
      {'answerText': 'Mediar con la contraparte', 'score': true},
    ],
  },
  {
    'question': 'assets/images/gameb_emocional/img5.png',
    'answers': [
      {'answerText': 'Soltar rencores y rabia', 'score': true},
    ],
  },
];
