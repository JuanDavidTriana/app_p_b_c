...
import 'package:app_p_b_c/emocional/games/game_b/emocional_game_b_widget.dart';
...
class EmocionalHerramientasBWidget extends StatefulWidget {
  const EmocionalHerramientasBWidget({Key key}) : super(key: key);

  @override
  _EmocionalHerramientasBWidgetState createState() =>
      _EmocionalHerramientasBWidgetState();
}

class _EmocionalHerramientasBWidgetState extends State<EmocionalHerramientasBWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/emocional_herramientas_b.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                                  ...
                                  child: ListView(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Image.asset(
                                            'assets/images/infografia_emocional_b.png',
                                                ...
                                                InkWell(
                                                  onTap: () async {
                                                    await Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                        builder: (context) => EmocionalGameBWidget(),
                                                      ),
                                                    );
                                                  },
                                                  child: Image.asset(
