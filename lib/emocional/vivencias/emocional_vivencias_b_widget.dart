...
class EmocionalVivenciasBWidget extends StatefulWidget {
  const EmocionalVivenciasBWidget({Key key}) : super(key: key);

  @override
  _EmocionalVivenciasBWidgetState createState() => _EmocionalVivenciasBWidgetState();
}

class _EmocionalVivenciasBWidgetState extends State<EmocionalVivenciasBWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/emocional_vivencias_b.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/XY_79eX2vNk',
