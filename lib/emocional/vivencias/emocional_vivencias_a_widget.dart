...
class EmocionalVivenciasAWidget extends StatefulWidget {
  const EmocionalVivenciasAWidget({Key key}) : super(key: key);

  @override
  _EmocionalVivenciasAWidgetState createState() => _EmocionalVivenciasAWidgetState();
}

class _EmocionalVivenciasAWidgetState extends State<EmocionalVivenciasAWidget> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.fill,
                      image: Image.asset(
                        'assets/images/emocional_vivencias_a.png',
                      ).image,
                    ),
                  ),
                  child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowYoutubePlayer(
                                  url: 'https://youtu.be/WJl1YegEL9c',
